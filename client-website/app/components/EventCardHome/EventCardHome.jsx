    ...
    return (
        <li className="event-card">
            <div className="event-card__info">
                <img src={event.thumbnail || hipHopCultureThumbnail} alt="Event thumbnail" />
                <div className="event-card__text">
                    ...
                    <div className="evnet-card__date">
                        <p>{getMonthAndDayString(event.startDate)}</p>
                        ...
                        <p>{getMonthAndDayString(getEndDate(event.startDate))}</p>
                    </div>
                </div>
            </div>
            <Link className="button button--yellow" to={`event-gallery/${event.id}`}>See Gallery</Link>
        </li>
    );
};
